...
- [ ] 2.2 テストを `internal/classify/classify_test.go` の `TestInProgressRules` へ足す。spec delta で足した 5 Scenario
...
- [ ] 3.1 `openspec validate s36-classify-reflected-pr --strict` と `go build ./... && go vet ./... && go test ./...` が
  すべて通ることを確認する
