...
func TestCardPicksHighestSituation(t *testing.T) {
	...
	got := Card(model.Card{Issue: &is, PRs: []model.PR{pr}})
...
func TestCardWithoutOpenPRUsesIssueSummary(t *testing.T) {
	...
	got := Card(model.Card{Issue: &is, PRs: []model.PR{mergedPR(131, model.LabelPropose)}})
...
func TestCardWithoutIssue(t *testing.T) {
	got := Card(model.Card{PRs: []model.PR{openPR(160, model.LabelDocs)}})
...
func TestCardCanonicalIgnoresOlderMergedPR(t *testing.T) {
	...
	got := Card(model.Card{Issue: &is, PRs: []model.PR{old, latest, open}})
